...
export const translations = {
  en: {
    ...
    contact: {
      title: "Contact Us",
      subtitle: "Have questions or need support? Our team is here to assist you.",
      nameLabel: "Full Name",
      ...
      infoDesc: "Feel free to reach out to us directly through any of the channels below.",
      address: "Office Address",
      addressValue: "Kigali, Rwanda",
      phone: "Phone Number",
      phoneValue: "+250 799 538 220",
      email: "Email Support",
      emailValue: "blessedirembo@gmail.com",
      hours: "Office Hours",
  ...
  rw: {
    ...
    contact: {
      title: "Twandikire",
      subtitle: "Ufite ikibazo cyangwa ukeneye ubufasha? Ikipe yacu iri hano ngo igufashe.",
      nameLabel: "Amazina Yose",
      namePlaceholder: "Andika amazina yose",
      emailLabel: "Imeri",
      emailPlaceholder: "izina@imeri.com",
      phoneLabel: "Nimero ya Terefone",
      phonePlaceholder: "+250 788 123 456",
      subjectLabel: "Intego / Igice",
      subjectPlaceholder: "Ni gute twagufasha?",
      messageLabel: "Ubutumwa",
      messagePlaceholder: "Andika ubutumwa bwawe hano...",
      submitButton: "Yohereza Ubutumwa",
      submitting: "Biracyoherezwa...",
      successTitle: "Ubutumwa Bwoherejwe!",
      successDesc: "Murakoze kutwandikira. Turakubaza bidatinze.",
      infoTitle: "Amakuru yo Kutwandikira",
      infoDesc: "Ushobora kutwandikira cyangwa kutuvugisha ako kanya binyuze mu buryo buri hano.",
      address: "Aho Dukorera",
      addressValue: "Kigali, Rwanda",
      phone: "Nimero ya Terefone",
      phoneValue: "+250 799 538 220",
      email: "Imeri y'Ubufasha",
      emailValue: "blessedirembo@gmail.com",
      hours: "Amasaha y'Akazi",
      hoursValue: "Kuwa Mbere - Kuwa Gatanu: 8:00 AM - 5:00 PM"
    }
  }
};
